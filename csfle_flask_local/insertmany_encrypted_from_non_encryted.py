...
data_key_id_1 = keyVaultClient.find_one({"keyAltNames": "localKey1"})["_id"]
data_key_id_2 = keyVaultClient.find_one({"keyAltNames": "localKey2"})["_id"]
data_key_id_3 = keyVaultClient.find_one({"keyAltNames": "localKey3"})["_id"]
data_key_id_4 = keyVaultClient.find_one({"keyAltNames": "localKey4"})["_id"]
...
non_encrypted_coll = unencrypted_client["localdb"]["patients_non_encrypted"]
patients_to_insert = []
